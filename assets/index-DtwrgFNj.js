 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var th;function A1(){return th||(th=1,function(e){function r(B,Q){var R=B.length;B.push(Q);e:for(;0<R;){var S=R-1>>>1,L=B[S];if(0<l(L,Q))B[S]=Q,B[R]=L,R=S;else break e}}function i(B){return B.length===0?null:B[0]}function s(B){if(B.length===0)return null;var Q=B[0],R=B.pop();if(R!==Q){B[0]=R;e:for(var S=0,L=B.length,Y=L>>>1;S<Y;){var ee=2*(S+1)-1,ie=B[ee],ae=ee+1,re=B[ae];if(0>l(ie,R))ae<L&&0>l(re,ie)?(B[S]=re,B[ae]=R,S=ae):(B[S]=ie,B[ee]=R,S=ee);else if(ae<L&&0>l(re,R))B[S]=re,B[ae]=R,S=ae;else break e}}return Q}function l(B,Q){var R=B.sortIndex-Q.sortIndex;return R!==0?R:B.id-Q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var c=performance;e.unstable_now=function(){return c.now()}}else{var f=Date,h=f.now();e.unstable_now=function(){return f.now()-h}}var p=[],m=[],y=1,v=null,x=3,E=!1,j=!1,T=!1,D=typeof setTimeout=="function"?setTimeout:null,_=typeof clearTimeout=="function"?clearTimeout:null,O=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function V(B){for(var Q=i(m);Q!==null;){if(Q.callback===null)s(m);else if(Q.startTime<=B)s(m),Q.sortIndex=Q.expirationTime,r(p,Q);else break;Q=i(m)}}function W(B){if(T=!1,V(B),!j)if(i(p)!==null)j=!0,ye($);else{var Q=i(m);Q!==null&&ce(W,Q.startTime-B)}}function $(B,Q){j=!1,T&&(T=!1,_(J),J=-1),E=!0;var R=x;try{for(V(Q),v=i(p);v!==null&&(!(v.expirationTime>Q)||B&&!Be());){var S=v.callback;if(typeof S=="function"){v.callback=null,x=v.priorityLevel;var L=S(v.expirationTime<=Q);Q=e.unstable_now(),typeof L=="function"?v.callback=L:v===i(p)&&s(p),V(Q)}else s(p);v=i(p)}if(v!==null)var Y=!0;else{var ee=i(m);ee!==null&&ce(W,ee.startTime-Q),Y=!1}return Y}finally{v=null,x=R,E=!1}}var U=!1,K=null,J=-1,ve=5,Ce=-1;function Be(){return!(e.unstable_now()-Ce<ve)}function Ye(){if(K!==null){var B=e.unstable_now();Ce=B;var Q=!0;try{Q=K(!0,B)}finally{Q?Ee():(U=!1,K=null)}}else U=!1}var Ee;if(typeof O=="function")Ee=function(){O(Ye)};else if(typeof MessageChannel<"u"){var Ue=new MessageChannel,qe=Ue.port2;Ue.port1.onmessage=Ye,Ee=function(){qe.postMessage(null)}}else Ee=function(){D(Ye,0)};function ye(B){K=B,U||(U=!0,Ee())}function ce(B,Q){J=D(function(){B(e.unstable_now())},Q)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(B){B.callback=null},e.unstable_continueExecution=function(){j||E||(j=!0,ye($))},e.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ve=0<B?Math.floor(1e3/B):5},e.unstable_getCurrentPriorityLevel=function(){return x},e.unstable_getFirstCallbackNode=function(){return i(p)},e.unstable_next=function(B){switch(x){case 1:case 2:case 3:var Q=3;break;default:Q=x}var R=x;x=Q;try{return B()}finally{x=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(B,Q){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var R=x;x=B;try{return Q()}finally{x=R}},e.unstable_scheduleCallback=function(B,Q,R){var S=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?S+R:S):R=S,B){case 1:var L=-1;break;case 2:L=250;break;case 5:L=1073741823;break;case 4:L=1e4;break;default:L=5e3}return L=R+L,B={id:y++,callback:Q,priorityLevel:B,startTime:R,expirationTime:L,sortIndex:-1},R>S?(B.sortIndex=R,r(m,B),i(p)===null&&B===i(m)&&(T?(_(J),J=-1):T=!0,ce(W,R-S))):(B.sortIndex=L,r(p,B),j||E||(j=!0,ye($))),B},e.unstable_shouldYield=Be,e.unstable_wrapCallback=function(B){var Q=x;return function(){var R=x;x=Q;try{return B.apply(this,arguments)}finally{x=R}}}}(pu)),pu}var nh;function R1(){return nh||(nh=1,fu.exports=A1()),fu.exports}/**
 * @license React
...
`;function lP(){const[e,r]=G.useState(!1),[i,s]=G.useState(!1);G.useEffect(()=>{const f=()=>{s(window.scrollY>50)};return window.addEventListener("scroll",f),()=>window.removeEventListener("scroll",f)},[]);const l=f=>{const h=document.getElementById(f);if(h){const y=h.getBoundingClientRect().top+window.pageYOffset-80;window.scrollTo({top:y,behavior:"smooth"})}r(!1)},c={hidden:{x:"100%"},visible:{x:0},exit:{x:"100%"}};return P.jsxs(P.Fragment,{children:[P.jsxs(tP,{scrolled:i,children:[P.jsx(nP,{onClick:()=>l("hero"),whileHover:{scale:1.05},whileTap:{scale:.95},children:"KI"}),P.jsxs(rP,{children:[P.jsx("a",{onClick:()=>l("hero"),children:"Home"}),P.jsx("a",{onClick:()=>l("about"),children:"About"}),P.jsx("a",{onClick:()=>l("experience"),children:"Experience"}),P.jsx("a",{onClick:()=>l("projects"),children:"Projects"}),P.jsx("a",{onClick:()=>l("contact"),children:"Contact"})]}),P.jsx(iP,{onClick:()=>r(!0),children:P.jsx(Jx,{})})]}),P.jsx(kc,{children:e&&P.jsxs(P.Fragment,{children:[P.jsx(aP,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:()=>r(!1)}),P.jsxs(oP,{initial:"hidden",animate:"visible",exit:"exit",variants:c,transition:{type:"spring",stiffness:300,damping:30},children:[P.jsx(sP,{onClick:()=>r(!1),children:P.jsx(Kg,{})}),P.jsx(Wi,{onClick:()=>l("hero"),children:"Home"}),P.jsx(Wi,{onClick:()=>l("about"),children:"About"}),P.jsx(Wi,{onClick:()=>l("experience"),children:"Experience"}),P.jsx(Wi,{onClick:()=>l("projects"),children:"Projects"}),P.jsx(Wi,{onClick:()=>l("contact"),children:"Contact"})]})]})})]})}const uP="/assets/shopkojiro-FO7Q1OH5.png",cP=I.section`
  position: relative;
  display: flex;
  flex-direction: column;
...
`,SP={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.2,delayChildren:.3}}},Nr={hidden:{opacity:0,y:30},visible:{opacity:1,y:0,transition:{duration:.6,ease:[.6,-.05,.01,.99]}}},kP=()=>P.jsx(cP,{id:"hero",children:P.jsxs(dP,{variants:SP,initial:"hidden",animate:"visible",children:[P.jsx(fP,{variants:Nr,children:P.jsx(pP,{children:P.jsx(hP,{src:uP,alt:"Khayrullo Isomiddinov"})})}),P.jsxs(mP,{children:[P.jsx(gP,{variants:Nr,children:"Hi, my name is"}),P.jsx(yP,{variants:Nr,children:"Khayrullo Isomiddinov."}),P.jsx(vP,{variants:Nr,children:"and I love building stuff."}),P.jsx(xP,{variants:Nr,children:"I'm a student of Computer Science at ELTE, and I am crazy about backend development, databases, and solving complex challenges."}),P.jsx(wP,{variants:Nr,href:"#projects",whileHover:{scale:1.05},whileTap:{scale:.95},children:"View My Work"})]})]})}),CP=I.section`
  padding: 3rem 1rem;
...
`;const KP=[{name:"Python",level:95},{name:"Java",level:80},{name:"JavaScript",level:70},{name:"C#",level:65},{name:"C",level:60},{name:"PHP",level:58},{name:"ADA",level:35}],GP=[{name:"React",level:88},{name:"FastAPI",level:85},{name:"Node.js",level:72},{name:"Laravel",level:55}],YP=[{name:"SQL (Databases)",level:92},{name:"Linux",level:92},{name:"Operating Systems",level:90}],QP=[{name:"Git",level:93},{name:"REST APIs",level:90},{name:"OOP Design Patterns",level:87},{name:"Docker",level:55}],XP=["Leadership","Team Collaboration","Critical Thinking","Problem-Solving","Adaptability","Time Management","Communication","Project Management"],qP=()=>{const{scrollYProgress:e}=Y2(),r=eP(e,[0,.3,.7,1],[1,1,.8,.6]),[i,s]=G.useState({programming:!0,frameworks:!1,databases:!1,devTools:!1}),l=T=>{s(D=>({...D,[T]:!D[T]}))},c={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.1,delayChildren:.2}}},f={hidden:{opacity:0,y:30,scale:.95},visible:{opacity:1,y:0,scale:1,transition:{duration:.6,ease:[.6,-.05,.01,.99]}}},h={hidden:{opacity:0,y:-30,scale:.9},visible:{opacity:1,y:0,scale:1,transition:{duration:.8,ease:[.6,-.05,.01,.99]}}},p={hidden:{opacity:0,scaleX:0},visible:{opacity:1,scaleX:1,transition:{duration:.8,delay:.3,ease:[.6,-.05,.01,.99]}}},m={hidden:{width:0},visible:T=>({width:`${T}%`,transition:{duration:1,delay:.2,ease:[.6,-.05,.01,.99]}})},y={hidden:{opacity:0,scale:0},visible:T=>({opacity:1,scale:1,transition:{duration:.5,delay:.5,ease:[.34,1.56,.64,1]}})},v={hidden:{opacity:0,scale:.8},visible:T=>({opacity:1,scale:1,transition:{duration:.4,delay:T*.05,ease:[.34,1.56,.64,1]}}),hover:{scale:1.05,transition:{duration:.2}}},x={open:{height:"auto",opacity:1,transition:{height:{duration:.4,ease:[.6,-.05,.01,.99]},opacity:{duration:.3,delay:.1}}},closed:{height:0,opacity:0,transition:{height:{duration:.4,ease:[.6,-.05,.01,.99]},opacity:{duration:.2}}}},E={open:{rotate:180},closed:{rotate:0}},j=(T,D,_=null,O)=>{const V=i[O];return P.jsxs(Km,{initial:"hidden",whileInView:"visible",viewport:{once:!0,margin:"-50px"},variants:f,children:[P.jsxs(Ty,{onClick:()=>l(O),whileHover:{scale:1.01},whileTap:{scale:.99},children:[P.jsx(Gm,{children:T}),P.jsx(_P,{variants:E,animate:V?"open":"closed",transition:{duration:.3,ease:[.6,-.05,.01,.99]},children:P.jsx(Kx,{})})]}),P.jsx(kc,{initial:!1,children:V&&P.jsx(IP,{initial:"closed",animate:"open",exit:"closed",variants:x,children:P.jsxs(OP,{children:[_&&P.jsx(VP,{as:fe.p,variants:f,children:_}),D.map((W,$)=>P.jsxs(zP,{variants:f,initial:"hidden",whileInView:"visible",viewport:{once:!0,margin:"-30px"},custom:$,children:[P.jsxs(NP,{children:[P.jsx($P,{children:W.name}),P.jsxs(FP,{variants:y,initial:"hidden",whileInView:"visible",viewport:{once:!0},custom:W.level,children:[W.level,"%"]})]}),P.jsx(BP,{children:P.jsx(UP,{custom:W.level,variants:m,initial:"hidden",whileInView:"visible",viewport:{once:!0}})})]},$))]})})})]})};return P.jsx(CP,{id:"about",style:{opacity:r},children:P.jsxs(PP,{children:[P.jsx(TP,{variants:h,initial:"hidden",whileInView:"visible",viewport:{once:!0},children:"About Me"}),P.jsx(EP,{variants:p,initial:"hidden",whileInView:"visible",viewport:{once:!0}}),P.jsxs(bP,{as:fe.div,variants:c,initial:"hidden",whileInView:"visible",viewport:{once:!0,margin:"-100px"},children:[P.jsxs(AP,{children:[P.jsxs(RP,{variants:f,whileHover:{scale:1.02,transition:{duration:.3}},children:[P.jsx("p",{children:"Hey there, thanks for checking out my portfolio!"}),P.jsx("p",{children:"Now that you are here, let me tell you a little bit about me. I am a student of computer science, and I am currently trying to break into the tech industry. I am doing so by thoroughly learning about databases, backend development (mainly using python FastAPI), as well as grasping the foundations of networking and configuration. I am taking CCNA prep courses in order to achieve it."}),P.jsx("p",{children:"As a lifelong learner, I like to be proactive, and spend as much time as possible on self improvement and skills acquisition. I mostly find myself enjoying my time tinkering with databases and the ways to optimize queries, learning in-depth about distributed systems, as well as trying to constantly improve my grades."}),P.jsx("p",{children:"Currently I am working on my thesis which focuses on building a real-time study-group event platform. I'm developing a FastAPI backend with clean models, proper indexing, and reliable state handling, and a React frontend that supports real-time chat through WebSockets. I use a vector-clock system to keep message ordering consistent even when clients lag or reconnect. The project covers event scheduling, role management, caching, and timezone correctness. I treat it like a production system, not a school assignment, to show I can design and ship a full-stack app end to end."})]}),P.jsxs(jP,{variants:f,whileHover:{scale:1.02,transition:{duration:.3}},children:[P.jsx(LP,{children:"What I'm Looking For"}),P.jsx(MP,{children:"I'm searching for internship / junior opportunities to work on challenging projects and collaborate with talented teams. May it be a development role, system design, or problem-solving, I'm ready to bring my skills to the table!"})]}),P.jsxs(Km,{as:fe.div,variants:f,initial:"hidden",whileInView:"visible",viewport:{once:!0,margin:"-50px"},children:[P.jsx(Gm,{as:fe.h3,variants:f,children:"Soft Skills"}),P.jsx(WP,{children:XP.map((T,D)=>P.jsx(HP,{variants:v,initial:"hidden",whileInView:"visible",viewport:{once:!0},whileHover:"hover",whileTap:{scale:.95},custom:D,children:T},D))})]})]}),P.jsxs(DP,{variants:f,children:[j("Programming Languages",KP,"Percentage represents knowledge depth and practical experience level.","programming"),j("Frameworks & Libraries",GP,null,"frameworks"),j("Databases & Systems",YP,null,"databases"),j("Development Tools",QP,null,"devTools")]})]})]})})},JP=I.section`
  padding: 4rem 2rem;
...
`);if(T===null||e(T)!=="object")throw new Error(D);if(Object.keys(T).length===1&&typeof T.advancedFraudSignals=="boolean")return T;throw new Error(D)},v,x=!1,E=function(){for(var T=arguments.length,D=new Array(T),_=0;_<T;_++)D[_]=arguments[_];x=!0;var O=Date.now();return p(v).then(function(V){return m(V,D,O)})};return E.setLoadParameters=function(j){if(x&&v){var T=y(j),D=Object.keys(T),_=D.reduce(function(O,V){var W;return O&&j[V]===((W=v)===null||W===void 0?void 0:W[V])},!0);if(_)return}if(x)throw new Error("You cannot change load parameters after calling loadStripe");v=y(j)},Ls.loadStripe=E,Ls}var Vu,fg;function eE(){return fg||(fg=1,Vu=ZT()),Vu}eE();function pg(e){let{prefix:r,field:i,errors:s,...l}=e;if(s==null)return null;let c=i?s.getFieldErrors(i):s.getFormErrors();return c.length===0?null:ge.createElement("div",{...l},r?`${r} `:null,c.map(f=>f.message).join(", "))}var tE=ge.createContext(null);function nE(){return G.useContext(tE)??{client:fc.getDefaultClient()}}var rE="2.5.1",iE=`@formspree/react@${rE}`;function oE(e,r={}){let i=nE(),{client:s=i.client,extraData:l,onError:c,onSuccess:f,origin:h}=r,{stripe:p}=s,m=G.useMemo(()=>p==null?void 0:p.elements().getElement(qT),[p]);return async function(y){let v=sE(y)?aE(y):y;if(typeof l=="object")for(let[E,j]of Object.entries(l)){let T;typeof j=="function"?T=await j():T=j,T!==void 0&&fc.appendExtraData(v,E,T)}let x=await s.submitForm(e,v,{endpoint:h,clientName:iE,createPaymentMethod:p&&m?()=>p.createPaymentMethod({type:"card",card:m,billing_details:lE(v)}):void 0});fc.isSubmissionError(x)?c==null||c(x):f==null||f(x)}}function sE(e){return"preventDefault"in e&&typeof e.preventDefault=="function"}function aE(e){e.preventDefault();let r=e.currentTarget;if(r.tagName!="FORM")throw new Error("submit was triggered for a non-form element");return new FormData(r)}function lE(e){let r={address:uE(e)};for(let i of["name","email","phone"]){let s=e instanceof FormData?e.get(i):e[i];s&&typeof s=="string"&&(r[i]=s)}return r}function uE(e){let r={};for(let[i,s]of[["address_line1","line1"],["address_line2","line2"],["address_city","city"],["address_country","country"],["address_state","state"],["address_postal_code","postal_code"]]){let l=e instanceof FormData?e.get(i):e[i];l&&typeof l=="string"&&(r[s]=l)}return r}function cE(e,r={}){let[i,s]=G.useState(null),[l,c]=G.useState(null),[f,h]=G.useState(!1),[p,m]=G.useState(!1),y=oE(e,{client:r.client,extraData:r.data,onError(v){s(v),h(!1),m(!1)},onSuccess(v){s(null),c(v),h(!1),m(!0)},origin:r.endpoint});return[{errors:i,result:l,submitting:f,succeeded:p},async function(v){h(!0),await y(v)},function(){s(null),c(null),h(!1),m(!1)}]}const hg=I.section`
...
`;I.div`
  ...
  align-items: center;
  gap: 0.5rem;
`;const kE=()=>{const[e,r]=cE("mdkaewvz");return e.succeeded?P.jsx(hg,{id:"contact",children:P.jsx(mg,{children:P.jsxs(vE,{initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},transition:{duration:.5},children:[P.jsx(xE,{children:"✓"}),P.jsx(wE,{children:"Message Sent!"}),P.jsx(SE,{children:"I've received your message and will get back to you as soon as possible. Looking forward to connecting with you!"})]})})}):P.jsx(hg,{id:"contact",children:P.jsxs(mg,{children:[P.jsx(dE,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6},children:"Get In Touch"}),P.jsx(fE,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6,delay:.1},children:"Whether you want to discuss a project, collaborate, or just say hello, feel free to drop a message. I'll get back to you as soon as I can!"}),P.jsx(pE,{}),P.jsxs(hE,{onSubmit:r,initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6,delay:.2},children:[P.jsxs(gg,{children:[P.jsxs(yg,{htmlFor:"email",children:[P.jsx(Xx,{size:16}),"Email Address"]}),P.jsx(mE,{id:"email",type:"email",name:"email",placeholder:"your.email@example.com",required:!0}),P.jsx(pg,{prefix:"Email",field:"email",errors:e.errors})]}),P.jsxs(gg,{children:[P.jsxs(yg,{htmlFor:"message",children:[P.jsx(Sh,{size:16}),"Message"]}),P.jsx(gE,{id:"message",name:"message",placeholder:"Tell me about your project, idea, or just say hello...",required:!0}),P.jsx(pg,{prefix:"Message",field:"message",errors:e.errors})]}),P.jsxs(yE,{type:"submit",disabled:e.submitting,whileHover:{scale:1.02},whileTap:{scale:.98},children:[P.jsx(Sh,{size:18}),e.submitting?"Sending...":"Send Message"]})]})]})})};function CE(e){return Rt({tag:"svg",attr:{viewBox:"0 0 496 512"},child:[{tag:"path",attr:{d:"M165.9 397.4c0 2-2.3 3.6-5.2 3.6-3.3.3-5.6-1.3-5.6-3.6 0-2 2.3-3.6 5.2-3.6 3-.3 5.6 1.3 5.6 3.6zm-31.1-4.5c-.7 2 1.3 4.3 4.3 4.9 2.6 1 5.6 0 6.2-2s-1.3-4.3-4.3-5.2c-2.6-.7-5.5.3-6.2 2.3zm44.2-1.7c-2.9.7-4.9 2.6-4.6 4.9.3 2 2.9 3.3 5.9 2.6 2.9-.7 4.9-2.6 4.6-4.6-.3-1.9-3-3.2-5.9-2.9zM244.8 8C106.1 8 0 113.3 0 252c0 110.9 69.8 205.8 169.5 239.2 12.8 2.3 17.3-5.6 17.3-12.1 0-6.2-.3-40.4-.3-61.4 0 0-70 15-84.7-29.8 0 0-11.4-29.1-27.8-36.6 0 0-22.9-15.7 1.6-15.4 0 0 24.9 2 38.6 25.8 21.9 38.6 58.6 27.5 72.9 20.9 2.3-16 8.8-27.1 16-33.7-55.9-6.2-112.3-14.3-112.3-110.5 0-27.5 7.6-41.3 23.6-58.9-2.6-6.5-11.1-33.3 2.6-67.9 20.9-6.5 69 27 69 27 20-5.6 41.5-8.5 62.8-8.5s42.8 2.9 62.8 8.5c0 0 48.1-33.6 69-27 13.7 34.7 5.2 61.4 2.6 67.9 16 17.7 25.8 31.5 25.8 58.9 0 96.5-58.9 104.2-114.8 110.5 9.2 7.9 17 22.9 17 46.4 0 33.7-.3 75.4-.3 83.6 0 6.5 4.6 14.4 17.3 12.1C428.2 457.8 496 362.9 496 252 496 113.3 383.5 8 244.8 8zM97.2 352.9c-1.3 1-1 3.3.7 5.2 1.6 1.6 3.9 2.3 5.2 1 1.3-1 1-3.3-.7-5.2-1.6-1.6-3.9-2.3-5.2-1zm-10.8-8.1c-.7 1.3.3 2.9 2.3 3.9 1.6 1 3.6.7 4.3-.7.7-1.3-.3-2.9-2.3-3.9-2-.6-3.6-.3-4.3.7zm32.4 35.6c-1.6 1.3-1 4.3 1.3 6.2 2.3 2.3 5.2 2.6 6.5 1 1.3-1.3.7-4.3-1.3-6.2-2.2-2.3-5.2-2.6-6.5-1zm-11.4-14.7c-1.6 1-1.6 3.6 0 5.9 1.6 2.3 4.3 3.3 5.6 2.3 1.6-1.3 1.6-3.9 0-6.2-1.4-2.3-4-3.3-5.6-2z"},child:[]}]})(e)}function PE(e){return Rt({tag:"svg",attr:{viewBox:"0 0 448 512"},child:[{tag:"path",attr:{d:"M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"},child:[]}]})(e)}const TE=I.footer`
  margin-top: 0;
  display: flex;
  flex-direction: row;
  align-items: center;
...
`,RE=I(fe.a)`
  ...
  &:hover {
    border-color: ${({theme:e})=>e.colors.accent};
    color: ${({theme:e})=>e.colors.accent};
    background: ${({theme:e})=>e.colors.accent}10;
    transform: translateY(-1px);
  }
`,jE=I.div`
  display: flex;
...
`,LE=()=>P.jsxs(TE,{children:[P.jsx(EE,{children:P.jsxs(bE,{children:["© ",new Date().getFullYear()," Khayrullo Isomiddinov"]})}),P.jsxs(AE,{children:[P.jsxs(RE,{href:"/khayrullo-isomiddinov/HarryResume.pdf",download:"HarryResume.pdf",whileHover:{scale:1.05},whileTap:{scale:.95},children:[P.jsx(Gx,{size:14}),"CV"]}),P.jsxs(jE,{children:[P.jsx(fe.a,{href:"https://github.com/khayrullo-isomiddinov",target:"_blank",rel:"noreferrer",whileHover:{scale:1.15},whileTap:{scale:.9},children:P.jsx(CE,{})}),P.jsx(fe.a,{href:"https://www.linkedin.com/in/khayrullo-isomiddinov",target:"_blank",rel:"noreferrer",whileHover:{scale:1.15},whileTap:{scale:.9},children:P.jsx(PE,{})})]})]})]}),ME=()=>P.jsxs(P.Fragment,{children:[P.jsx(lP,{}),P.jsx(kP,{}),P.jsx(qP,{}),P.jsx(mT,{}),P.jsx(IT,{}),P.jsx(kE,{}),P.jsx(LE,{})]}),DE={colors:{background:"#0f0f23",backgroundSecondary:"#1a1a2e",text:"#e4e4e7",textSecondary:"#a1a1aa",accent:"#8b5cf6",accentHover:"#7c3aed",border:"#27272a",shadow:"#000000",mobileMenuBg:"rgba(15, 15, 35, 0.98)",mobileMenuText:"#e4e4e7",overlay:"rgba(0, 0, 0, 0.75)",cardBg:"#1a1a2e",cardHover:"#252538"},fontSizes:{xs:"0.8rem",sm:"1rem",md:"1.2rem",lg:"1.5rem",xl:"2rem","2xl":"3rem"},transitions:{default:"all 0.3s ease-in-out",hover:"color 0.2s ease-in-out, background 0.2s ease-in-out, box-shadow 0.2s ease-in-out"},shadows:{card:"0 4px 6px -1px rgba(0, 0, 0, 0.3), 0 2px 4px -1px rgba(0, 0, 0, 0.2)",hover:"0 10px 15px -3px rgba(139, 92, 246, 0.3), 0 4px 6px -2px rgba(139, 92, 246, 0.2)",header:"0 1px 3px rgba(0, 0, 0, 0.4)",modal:"0 25px 50px -12px rgba(0, 0, 0, 0.5)"},animations:{fadeIn:"fadeIn 0.8s ease-out forwards",glow:"glow 1.5s ease-in-out infinite",pulse:"pulse 2s infinite ease-in-out"},breakpoints:{xs:"320px",sm:"480px",md:"768px",lg:"1024px",xl:"1280px"}},_E=Ox`
...
`;_1.createRoot(document.getElementById("root")).render(P.jsx(ge.StrictMode,{children:P.jsxs(Dx,{theme:DE,children:[P.jsx(_E,{}),P.jsx(ME,{})]})}));
